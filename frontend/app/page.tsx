const events = [
  { id: 1, title: 'Concert de Jazz', date: '2023-12-25', location: 'Paris', image: 'https://images.unsplash.com/photo-1511192336575-5a79af67a629?auto=format&fit=crop&q=80&w=800' },
  ...
  { id: 3, title: 'Atelier Cuisine', date: '2024-02-10', location: 'Bordeaux', image: 'https://images.unsplash.com/photo-1606787366850-de6330128bfc?auto=format&fit=crop&q=80&w=800' },
];
